  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="card max-w-md mx-auto bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
          <div className="mb-6">
            <p className="text-blue-800 font-semibold mb-2">5,672 members and growing!</p>
